...
namespace TrashCollector.Data
{
    public class CustomerRepository : RepositoryBase<Customer>, ICustomerRepository
    {
        ...
        public IQueryable<Customer> GetCustomersByZipCodeAndDate(int zipCode, DateTime date) => FindByConditionWithInclude(c => c.Address.ZipCode == zipCode && (c.Pickup.PickupDay == date.DayOfWeek.ToString() || c.Pickup.OneTimePickup.Date == date.Date), a => a.Address, p => p.Pickup);
